...
def monitor_for_text(reference_image_path, threshold=0.60):
    ...
    watch_x1, watch_y1, watch_x2, watch_y2 = 607, 350, 823, 385
    ...
    while True:
        try:
            ...
            if max_val >= threshold:
                ...
                final_screenshot = pyautogui.screenshot(region=(
                    screenshot_x1, screenshot_y1, screenshot_x2 - screenshot_x1, screenshot_y2 - screenshot_y1
                ))
...
# Example usage
result = monitor_for_text(reference_image_path="flew_away_template.png", threshold=0.50)
print(result)
